...
public class GetDriveCardPhotoActivity extends BaseActivity implements View.OnClickListener, Camera.PreviewCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_get_drive_card);
    ...
    public boolean saveBitmap(Bitmap bm) {
        ...
        fileUrl = "/sdcard/DCIM/Camera/" + longTime + "card001.png";
        //        Log.e(TAG, "保存图片");
        File file = new File("/sdcard/DCIM/Camera/", longTime + "card001.png");
        if (file.exists()) {
            file.delete();
        }
        try {
