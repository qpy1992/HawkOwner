...
public class Rotate3dAnimation extends Animation {
    ...
    public Rotate3dAnimation(Context context, AttributeSet attrs) {
        ...
        mFromDegrees = a.getFloat(R.styleable.m_Rotate3dAnimation_m_fromDeg, 0.0f);
        mToDegrees = a.getFloat(R.styleable.m_Rotate3dAnimation_m_toDeg, 0.0f);
        mRollType = a.getInt(R.styleable.m_Rotate3dAnimation_m_rollType, ROLL_BY_X);
        Description d = parseValue(a.peekValue(R.styleable.m_Rotate3dAnimation_m_pivotX));
        mPivotXType = d.type;
        mPivotXValue = d.value;

        d = parseValue(a.peekValue(R.styleable.m_Rotate3dAnimation_m_pivotY));
        mPivotYType = d.type;
