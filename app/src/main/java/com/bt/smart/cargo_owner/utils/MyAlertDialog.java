...
public class MyAlertDialog extends Dialog implements View.OnClickListener {
    ...
    public static final int WARNING_TYPE_1 = 7;
        ...
        if (mDialogView != null) {
            ...
            switch (mAlertType) {
                case ERROR_TYPE:
                    ...
                    break;
                case SUCCESS_TYPE:
                    mlayout_dialog.setBackgroundResource(R.drawable.dialog_background);
                    mSuccessFrame.setVisibility(View.VISIBLE);
                    // initial rotate layout of success mask
                    mSuccessLeftMask.startAnimation(mSuccessLayoutAnimSet.getAnimations().get(0));
                    mSuccessRightMask.startAnimation(mSuccessLayoutAnimSet.getAnimations().get(1));
                    break;
                case WARNING_TYPE:  // 第一个按钮是取消，第二个按钮是默认的  一版用于 确定 等  没有图标
                    if (mCancelButton != null && mCancelButton.getVisibility() == View.VISIBLE ) {
                        mConfirmButton.setBackgroundResource(R.drawable.dialog_background_bntright);
                    }else{
                        mConfirmButton.setBackgroundResource(R.drawable.dialog_background_onebnt);
                    }

                    mWarningFrame.setVisibility(View.GONE);
                    break;
                case WARNING_TYPE_1:  // 第一个按钮是取消，第二个按钮是默认的  一版用于 确定 等
                    if (mCancelButton != null && mCancelButton.getVisibility() == View.VISIBLE ) {
                        mConfirmButton.setBackgroundResource(R.drawable.dialog_background_bntright);
                    }else{
                        mConfirmButton.setBackgroundResource(R.drawable.dialog_background_onebnt);
                    ...
                    break;
                case WARNING_TYPE_2:// 第一个按钮是取消，第二个按钮是红色的  一般用于 确定删除 等
                    if (mCancelButton != null && mCancelButton.getVisibility() == View.VISIBLE ) {
                        mConfirmButton.setBackgroundResource(R.drawable.red_button_background_right);
                    }else{
                ...
                case CUSTOM_IMAGE_TYPE:
                    ...
                    break;
                case PROGRESS_TYPE:
                    mlayout_dialog.setBackgroundResource(R.drawable.dialog_background_2);
    ...
    public MyAlertDialog setCustomImage (Drawable drawable) {
    ...
    public MyAlertDialog setCustomImage (int resourceId) {
    ...
    public MyAlertDialog showTitleText (boolean isShow) {
        mShowTitle = isShow;
    ...
    public MyAlertDialog setCancelClickListener (OnSweetClickListener listener) {
        mCancelClickListener = listener;
        return this;
    }

    public MyAlertDialog setConfirmClickListener (OnSweetClickListener listener) {
